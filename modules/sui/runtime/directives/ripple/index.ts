...
type SUIRippleEvent = (MouseEvent | TouchEvent | KeyboardEvent) & { [stopSymbol]?: boolean }
...
function isTouchEvent(e: SUIRippleEvent): e is TouchEvent {
  return e.constructor.name === 'TouchEvent'
}

function isKeyboardEvent(e: SUIRippleEvent): e is KeyboardEvent {
...
function rippleShow(e: SUIRippleEvent) {
...
function rippleStop(e: SUIRippleEvent) {
  e[stopSymbol] = true
}
